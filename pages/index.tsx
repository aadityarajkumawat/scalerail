      ...
      <div className="parallax-item">
        <div className="max-w-3xl m-auto">
          ...
          <p className="text-3xl text-pleasant-blue leading-snug">
            The most productive human in the history of the world is alive today
            - and we think he needs more than a spreadsheet.
          </p>
          <p className="my-10 text-lg">
            Our tools are designed to maximize the most important metric at your
            company &quot;average hours of focused attention&quot;
          </p>
          <p className="my-10 text-lg">
          ...
          <p className="my-10 text-lg">
            We believe everyone should have access to powerful tools that enable
            peak productivity. With our tools, you&apos;ll be able to work
      ...
      <div className="parallax-item">
        <div className="max-w-3xl m-auto">
          ...
          <p className="my-10 text-lg">
            ...
            achieve your fullest potential and make unique connections that can
            have positive impacts on your life
          </p>
          <p className="my-10 text-lg">
